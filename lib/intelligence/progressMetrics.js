    ...
    metrics: [
      {
        ...
        // LEDGER_RECONSTRUCTED: summed from income_entry rows, not a frozen
        // snapshot value.  monthly_reviews stores net_surplus (SNAPSHOT) but
        // does NOT store total income — so reconstructing from the ledger is
