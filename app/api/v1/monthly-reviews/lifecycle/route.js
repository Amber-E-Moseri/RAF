...
import { getMonthLifecycleState, transitionToReviewing, MonthlyReviewHttpError } from '../../../../../lib/monthlyReviews/monthlyLifecycle.js';
...
export async function GET(request, context = {}) {
  try {
    ...
    const result = await getMonthLifecycleState({
      db: getDb(context),
