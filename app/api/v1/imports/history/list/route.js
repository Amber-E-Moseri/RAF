import { listImportHistory } from '../../../../../../lib/imports/importHistory.js';
...
export async function GET(request, context = {}) {
  try {
    const result = await listImportHistory({ db: getDb(context), householdId: getHouseholdId(request, context) });
