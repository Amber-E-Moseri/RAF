...
import { TransactionImportWorkflow } from "./TransactionImportWorkflow";
    ...
    >
      ...
      {showImportWorkflow ? (
        <TransactionImportWorkflow
          ...
          onSelectedImportFileChange={setSelectedImportFile}
          isImporting={isImporting}
          importError={importError}
          importSuccess={importSuccess}
          onImportUpload={handleImportUpload}
          onImportRefresh={() => reload()}
          activeMonthLabel={activeMonthLabel}
          importsSummary={importsSummary}
          isImportsExpanded={isImportsExpanded}
          onImportsExpandedChange={setIsImportsExpanded}
          importsView={importsView}
          onImportsViewChange={setImportsView}
          needsReviewImports={needsReviewImports}
          ignoredImports={ignoredImports}
          processedImports={processedImports}
          selectedImportIds={selectedImportIds}
          bulkBucketId={bulkBucketId}
          bulkRuleMode={bulkRuleMode}
          ...
          error={error}
          data={data}
          importPanelModes={importPanelModes}
          openImportMenuId={openImportMenuId}
          openAdvancedMenuId={openAdvancedMenuId}
          editingRuleId={editingRuleId}
          dismissedRuleEffects={dismissedRuleEffects}
          importsInView={importsInView}
          onToggleSelectAllImports={toggleSelectAllImports}
          onToggleImportSelection={toggleImportSelection}
          onBulkBucketIdChange={setBulkBucketId}
          onBulkRuleModeChange={setBulkRuleMode}
          onBulkReview={() => handleBulkReview("approve")}
          onAdvanceToNextUnreviewed={advanceToNextUnreviewed}
          onOpenImportMenu={toggleImportMenu}
          onUpdateReviewDraft={updateReviewDraft}
          onApplySuggestion={applySuggestion}
          onResetRuleEffect={resetRuleEffect}
          onHandleReviewImportedRow={handleReviewImportedRow}
          onHandleUnignoreImportedRow={handleUnignoreImportedRow}
          onHandleUnprocessImportedRow={handleUnprocessImportedRow}
          ...
          onHandleSaveRuleEdits={handleSaveRuleEdits}
          isHistoryExpanded={isHistoryExpanded}
          onHistoryExpandedChange={setIsHistoryExpanded}
          selectedImportHistoryId={selectedImportHistoryId}
          isLoadingImportHistoryDetail={isLoadingImportHistoryDetail}
          importHistoryDetailError={importHistoryDetailError}
          importHistoryDetail={importHistoryDetail}
          onSelectImportHistory={selectImportHistory}
          onClose={() => setShowImportWorkflow(false)}
          getReviewDraft={getReviewDraft}
          importRowStatus={importRowStatus}
          importStateNote={importStateNote}
          getBucketLabel={getBucketLabel}
          getLinkedLabel={getLinkedLabel}
          primaryReviewLabel={primaryReviewLabel}
          requiresCategorySelection={requiresCategorySelection}
          requiresDebtSelection={requiresDebtSelection}
          requiresFixedBillSelection={requiresFixedBillSelection}
          requiresGoalSelection={requiresGoalSelection}
          getRuleDraft={getRuleDraft}
          updateRuleDraft={updateRuleDraft}
          looksLikeSavingsTransfer={looksLikeSavingsTransfer}
          importHistoryTitle={importHistoryTitle}
          importHistoryAccountLabel={importHistoryAccountLabel}
          importHistoryReviewLabel={importHistoryReviewLabel}
          importHistoryLinkedLabel={importHistoryLinkedLabel}
          debtLookup={debtLookup}
          fixedBillLookup={fixedBillLookup}
